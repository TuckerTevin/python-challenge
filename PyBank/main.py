...
average_month_change = total_month_change / (total_amount_of_months - 1)

# Print the analysis to terminal
print("Financial Analysis")
print("----------------------------")
print("Total Months: " + str(total_amount_of_months))
...
f.write("----------------------------\n")
f.write("Total Months: " + str(total_amount_of_months) + "\n")
